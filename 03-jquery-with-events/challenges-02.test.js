...
const grandTotal = (hours, stores) => {
  ...
  // iterate over stores array
  // store hourly cookies sold at each index into temporary variable
  // push temp variable into array if no pre-existing value at specified index
  // if value at index of array already exists, sum to existing value
...
const salesData = (data) => {
  ...
  hourlySales.forEach((hourlyTotal, idx) => {
    formattedData.push({
